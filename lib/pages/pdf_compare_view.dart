        ...
        bottom: PreferredSize(
          ...
          child: Padding(
            ...
            child: SegmentedButton<_CompareMode>(
              segments: [
                ButtonSegment(value: _CompareMode.sideBySide, label: Text(L10n.of(context).sideBySide), icon: const Icon(Icons.view_agenda_outlined)),
                ButtonSegment(value: _CompareMode.overlay, label: Text(L10n.of(context).overlayLabel), icon: const Icon(Icons.layers_outlined)),
              ],
              selected: {_mode},
