...
class _AnnotatePdfViewState extends State<AnnotatePdfView> {
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        ...
        child: Row(children: [
          ...
          _toolBtn(_Tool.highlighter, Icons.highlight_outlined, L10n.of(context).annotateHighlight, theme),
          _toolBtn(_Tool.eraser, Icons.auto_fix_normal, L10n.of(context).annotateEraser, theme),
          _vDivider(),
          _toolBtn(_Tool.text, Icons.text_fields, 'Text', theme),
          _toolBtn(_Tool.sticky, Icons.sticky_note_2_outlined, L10n.of(context).annotateSticky, theme),
          _vDivider(),
          _toolBtn(_Tool.rect, Icons.crop_square_outlined, L10n.of(context).annotateRectangle, theme),
          _toolBtn(_Tool.ellipse, Icons.circle_outlined, L10n.of(context).annotateEllipse, theme),
          _toolBtn(_Tool.line, Icons.remove, L10n.of(context).annotateLine, theme),
          _toolBtn(_Tool.arrow, Icons.arrow_forward_outlined, L10n.of(context).annotateArrow, theme),
        ]),
      ),
    );
  }
  ...
  Widget _buildSaveBar(ThemeData theme, PdfState state) {
    ...
    final loading = state.httpStates[HttpStates.stampPdf]?.loading == true;
    return Container(
