    ...
    final categories = [
      _ToolCategory(
        ...
        tools: [
          ...
          _ToolItem(name: 'Sign PDF', icon: Icons.draw, onTap: () => router.pushNamed(AppRoutes.fileManagement.name, extra: FileSelectionConfig(path: Constants.rootStoragePath, redirectPath: AppRoutes.signPdfRoute.path, multiSelect: false, limitToExtensions: pdf))),
      ...
      _ToolCategory(
        ...
        tools: [
          ...
          _ToolItem(name: 'Optimize PDF', icon: Icons.auto_fix_high, onTap: () => router.pushNamed(AppRoutes.fileManagement.name, extra: FileSelectionConfig(path: Constants.rootStoragePath, redirectPath: AppRoutes.optimizePdfRoute.path, multiSelect: false, limitToExtensions: pdf))),
          _ToolItem(name: 'Remove Blanks', icon: Icons.delete_sweep_outlined, onTap: () => router.pushNamed(AppRoutes.fileManagement.name, extra: FileSelectionConfig(path: Constants.rootStoragePath, redirectPath: AppRoutes.removeBlankPagesRoute.path, multiSelect: false, limitToExtensions: pdf))),
          _ToolItem(name: 'N-Up Layout', icon: Icons.view_module_outlined, onTap: () => router.pushNamed(AppRoutes.fileManagement.name, extra: FileSelectionConfig(path: Constants.rootStoragePath, redirectPath: AppRoutes.nUpPdfRoute.path, multiSelect: false, limitToExtensions: pdf))),
