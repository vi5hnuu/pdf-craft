                              ...
                              children: [
                                Expanded(
                                  child: DropdownButtonFormField<PdfFontName>(
                                    ...
                                    decoration: InputDecoration(labelText: L10n.of(context).fontLabel, border: const OutlineInputBorder(), contentPadding: const EdgeInsets.symmetric(horizontal: 12, vertical: 14)),
                                ...
                                SizedBox(
                                  ...
                                  child: TextFormField(
                                    ...
                                    decoration: InputDecoration(labelText: L10n.of(context).sortSize, border: const OutlineInputBorder()),
